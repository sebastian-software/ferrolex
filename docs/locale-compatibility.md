...
| `hu_HU` | Latin | AFF declares UTF-8 with reviewed ISO-8859-2 fallback; DIC UTF-8 | Blocked | The digest-verified pair has a lenient cache fixture with stem, affix, and compound probes. Repeating that exact decoder in strict mode rejects `COMPOUNDFIRST`, `COMPOUNDLAST`, `COMPOUNDROOT`, `GENERATE`, `HU_KOTOHANGZO`, `LEMMA_PRESENT`, `ONLYROOT`, `SUBSTANDARD`, `SYLLABLENUM`, and malformed `entry` rows. This is a documented boundary, not parity evidence. |
