...
| `de_DE` | Latin | ISO-8859-1 | Blocked | The byte importer decodes ISO-8859-1, recognizes bounded positioned compound affixes, and handles its literal `-`/`.` breaks; `CHECKSHARPS` and `WORDCHARS` still block strict installation. |
