...
| `de_DE` | Latin | ISO-8859-1 | Blocked | Needs lossless ISO-8859-1 decoding; compound-position directives, `COMPOUNDPERMITFLAG`, `BREAK`, and `WORDCHARS` are also outside the subset. |
